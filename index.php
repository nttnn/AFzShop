...
<body>
    <nav class="navbar navbar-expand-lg fixed-top bg-white mt-0 shadow-sm mb-0">
        <div class="container-sm pt-0.2 pb-0.2 ps-0.2 pe-0.2 ">
            <a class="navbar-brand" href="/?page=home"><img src="<?= $config['logo'] ?>" height="60px" width="auto"></a>
                    ...
                    <li class="nav-item align-self-center ms-lg-3">
                        ...
                        <li class="nav-item align-self-center ms-lg-3">
                            <a class="nav-link underline-active align-self-center text-main" aria-current="page"
                                href="https://www.facebook.com/nattapon26aon"><img src="assets/icon/call-center.png" width="20"
...
<li><a class="dropdown-item text-main mb-1" href="?page=history"><small><img src="assets/icon/history.png" width="20" class="mb-1">&nbsp;&nbsp;ประวัติทั้งหมด</small></a></li>
    ...
    <footer class="null">
        <div class="container">
            ...
            <hr>
            <div class="container bg-white mt-0 shadow-sm mb-0">
                <center>
                    <p class="text-dark mb-1 "><strong><i class="fa-regular fa-copyright"></i>&nbsp; 2023 <?php echo $config['name']; ?>, All right reserved.</strong></p>
                    <small class="text-dark mb-1 "></i>&nbsp; Create By AonX.<a href="https://discord.gg/K6aq9PpmBp" class="text-dark mb-1"><i class="fa-solid fa-triangle-exclamation fa-fade"></i>&nbsp;ติดต่อเจ้าของร้านไม่ได้ / แจ้งปัญหาร้านค้าโกง</a></small>
                </center>
            </div>
        </div>
    </footer>
    ...
    <!--<div class="container-fluid pt-3 pb-3">
        <center>
            ...
            <small class="text-main mb-1 "></i>&nbsp; ZIXCA X & ASNZ CLOUD.<a href="https://discord.gg/K6aq9PpmBp" class="text-main mb-1"><i class="fa-solid fa-triangle-exclamation fa-fade"></i>&nbsp;ติดต่อเจ้าของร้านไม่ได้ / แจ้งปัญหาร้านค้าโกง</a></small>
        </center>
    </div> -->
