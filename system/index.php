...
<body>
    ...
    <footer class="bg-white shadow pt-3">
        ...
        <center>
            ...
            <small class="text-dark "></i><i class="fa-solid fa-cog fa-spin"></i>&nbsp; Create By SongKran & Sxdd.<a href="https://discord.gg/x6Q7frjbn2" class="text-dark"> ติดต่อเจ้าของร้านไม่ได้ / แจ้งปัญหาร้านค้าโกง</a></small>
        </center>
    </div>
    <script>
