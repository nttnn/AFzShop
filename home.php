...
<body>
    <main>
        ...
        <div class="container">
            <!-- <nav class="navbar" style="position: fixed; z-index: 100;">
                <img src="<?= $config['logo'] ?>" width="40">
                <span class="navbar-brand mb-0 ms-3 text-white" style="font-size: 15px; text-shadow: 0 0 5px black;"><?= $config['name'] ?></span>
            </nav> -->
        </div>
        <div class="bg-80 p-3">
    ...
    <center>
        ...
        <small class="text-white mb-1 "></i>&nbsp; Create By SongKran & Overdrive-C.<a href="https://discord.gg/x6Q7frjbn2" class="text-white mb-1"><i class="fa-solid fa-triangle-exclamation fa-fade"></i>&nbsp;ติดต่อเจ้าของร้านไม่ได้ / แจ้งปัญหาร้านค้าโกง</a></small>
    </center>
